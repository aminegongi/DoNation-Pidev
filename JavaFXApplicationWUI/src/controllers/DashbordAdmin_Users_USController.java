            ...
            actions.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent event) {
                    if (actions.getValue().equals("Voir Profil")) {
                        ...
                        Image MailImg = new Image(getClass().getResourceAsStream("/images/Icon/icons8_phone_26px_1.png"));
                        Image phoneImg = new Image(getClass().getResourceAsStream("/images/Icon/icons8_phone_26px_1.png"));
                        Image adresseImg = new Image(getClass().getResourceAsStream("/images/Icon/icons8_phone_26px_1.png"));
                        Image genreImg = new Image(getClass().getResourceAsStream("/images/Icon/icons8_phone_26px_1.png"));
                        
                        
                        tel.setGraphic(new ImageView(phoneImg));
                        
                        vboxDProfil.getChildren().addAll(np,Mail,tel,adresse,genre,pointxp,dateNaissance,dateInscri);
