...
public class Utilisateur {
    ...
    public Utilisateur(String mail, String mdp, String salt, String numTel, Adresse adresse, String image, int pointXP, int enabled, String confirmation_token, Date password_requested_at, String nom) {
        this.mail = mail;
        this.mdp = mdp;
        this.salt = salt;
        this.numTel = numTel;
