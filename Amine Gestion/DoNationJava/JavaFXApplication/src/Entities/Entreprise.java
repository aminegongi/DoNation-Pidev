...
public class Entreprise extends Utilisateur{
    ...
    public Entreprise(String matriculeFiscale, String pageFb, String siteWeb, String description, float latitude, float longitude, String mail, String mdp, String salt, String numTel, Adresse adresse, String image, int pointXP, int enabled, String confirmation_token, Date password_requested_at, String nom) {
