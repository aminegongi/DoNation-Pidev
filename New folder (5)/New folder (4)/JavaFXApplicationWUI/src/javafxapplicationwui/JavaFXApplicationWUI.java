...
//       Categorie_EmploisService cat = new Categorie_EmploisService();
    //Emplois e1=  new Emplois("yyoooosri", "math", "xxxxx", 500.2, "Tunis", "Offre", "ContratUniqueInsertion",11);
//   Emplois e2=  new Emplois("test", "valid", "yyyy", 55.6, "Ariana", "Offre", "ContratUniqueInsertion",1);
...
//      // cat.updateCategorieEmplois(c2,3);
 //serv.update(e2,24);
      //  serv.delete(29);
//            List<Emplois> list1 = serv.readAll();
